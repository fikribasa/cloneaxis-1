    ...
    render() { 
        return (
            <View style={{ flex: 1, position: 'relative', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <TextInput
                    keyboardType='number-pad' autoFocus={true} returnKeyType='go' style={{ height: 80, width: '90%', color: '#6F2A94', elevation: 5, backgroundColor: 'white', marginTop: 130, fontSize: 40, paddingHorizontal: 20, textAlign: 'center', fontWeight: 'bold' }} maxLength={13} placeholder='083XXXXXXXXXX'

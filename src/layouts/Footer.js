...
const Footer = props => {
    return (
        <SafeAreaView style={{ marginTop: -10, height: 55, position: 'relative', flexDirection: 'row' }}>
            <Image source={ require('../assets/background/navbar_shape.webp') } style={{ resizeMode: 'contain', width: '100%', height: '100%', position: 'absolute' }} />
